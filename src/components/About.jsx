...
export default function About() {
    return(
        <div className="flex flex-col md:flex-row items-center bg-[#FEFED2] min-h-screen py-10 px-5">
        ...
        <div className="flex flex-row items-center max-w-sm justify-center">
            <motion.img 
            className="mix-blend-multiply"
            src="/gallery/loaf1.jpeg" 
